...
public class Server {
    ...
    private static String rateFilm(String[] components) {
        String response;
    ...
    private static String searchByName(String[] components){
        String response;
    ...
    private static String searchByGenre(String[] components){
